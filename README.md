...
Most of the code was taken from old (15 years+!) pet project [https://github.com/mnvl/engine](engine), the bindings and the documentation were mostly generated by Claude with my curation.
